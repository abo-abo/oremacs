...
(add-hook 'calc-mode-hook 'ora-calc-hook)
...
(add-hook 'docker-image-mode-hook 'ora-docker-image-hook)
...
(eval-after-load 'epa-hook '(require 'ora-epa))
(eval-after-load 'counsel-keepassxc '(require 'ora-keepassxc))
